<template>
  <div class="go-in">
    <banner img="../assets/img/bgtop.jpg" title="走进聚农宝" />
      ...
      <div class="section-content">
        <div class="content-summary">
          <div class="summary-left">
            ...
            <p class="content">
              陕西聚农宝科技发展有限公司，成立于2018年。目前正在运营的产品有智慧枣乡APP、微信小程序平台运营；
              枣棚智能温控设备；棚体智能监测设备的研发与销售；冷棚升级项目；大荔冬枣购销、出口；支付宝服务商。
              未来，我们的业务体系将逐步延伸到冬枣生产资料、农业金融服务、大荔冬枣大数据、冬枣产地溯源系统等其他领域，
              致力于打造农业互联网体系的生态圈。
            </p>
          </div>
          <div class="summary-right">
            <img src="../assets/img/goin_title.jpg" alt />
          </div>
        </div>
...
.top {
  ...
  .border {
    border-bottom: 1px solid #069752;
    width: 15%;
    margin: 0 auto;
  }
}
