      ...
      <swiper-slide class="swiper-slide slide-two">
        ...
        <ul class="case-item">
          <li
            ...
            :key="index"
            v-lazy:background-image=" baseApi + item.img"
          >
            <router-link
        ...
        <div class="news-content">
          <div class="news-content-item" v-for="(news,i) in newsList" :key="i">
            <div :style="'order: '+ (i%2 === 0 ? 1: 3)">
              ...
              >
                <div class="item-img" v-lazy:background-image="baseApi + news.img"></div>
              </router-link>
            </div>
            <div style="order: 2">
              <el-divider>
...
import { getCaseList, getNewsList } from '@/api/home'
...
/*  mounted() {
    baseService.all([getNewsList(), getNewsAll({ type: 1, num: 3 })]).then(
